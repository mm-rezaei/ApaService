...
{
    [DatabaseObject("ShopDeliveryMethod")][DataModel][DataContract(IsReference = true)]
    public partial class AdministratorShopDeliveryMethodDataModel : ApasDataModelBase
    {
