...
{
    [DatabaseObject("AccountAdministrator")][DataModel][DataContract(IsReference = true)]
    public partial class AdministratorAccountAdministratorDataModel : AdministratorAccountDataModelBase
    {
    }
}
