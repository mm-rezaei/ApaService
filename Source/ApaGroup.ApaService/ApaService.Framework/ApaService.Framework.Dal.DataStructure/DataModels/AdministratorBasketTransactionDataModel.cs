...
{
    [DatabaseObject("BasketTransaction")][DataModel][DataContract(IsReference = true)]
    public partial class AdministratorBasketTransactionDataModel : AdministratorTransactionDataModelBase
    {
