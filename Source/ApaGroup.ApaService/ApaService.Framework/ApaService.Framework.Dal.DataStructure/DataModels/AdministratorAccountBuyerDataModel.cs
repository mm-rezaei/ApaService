...
{
    [DatabaseObject("AccountBuyer")][DataModel][DataContract(IsReference = true)]
    public partial class AdministratorAccountBuyerDataModel : AdministratorAccountDataModelBase
    {
    }
}
