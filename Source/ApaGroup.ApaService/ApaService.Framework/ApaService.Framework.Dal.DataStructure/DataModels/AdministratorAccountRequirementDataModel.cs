...
{
    [DatabaseObject("AccountRequirement")][DataModel][DataContract(IsReference = true)]
    public partial class AdministratorAccountRequirementDataModel : AdministratorAccountDataModelBase
    {
    }
}
